...
for cm_target in scenario_cms:
    ...
    if denom <= 0:
        ...
        # Round up to next $0.05 logic (applied to Wholesale directly this time since we are showing wholesale)
        # However, to be consistent with retail rounding:
        # Convert to retail -> round retail -> divide by 2
...
# Styling the dataframe to look clean
st.dataframe(
